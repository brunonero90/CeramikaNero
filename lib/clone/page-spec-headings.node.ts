/**
 * Node/fs-backed page-spec helpers for local fidelity tests and audits.
 * Do not import this from production App Router pages — NFT would pull
 * `reference/` (500MB+) into the Netlify server handler.
 */
